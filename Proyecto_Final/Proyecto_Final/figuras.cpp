...
void CFiguras::paralelogramo(float largo, float profundidad, float altura, float angulo, GLuint text)  //Funcion creacion prisma
{
	...
	if (angulo == 0) {
		...
		desp = ((altura / 2) / tan((angulo*(3.14159265359)) / 180));

	}

	GLfloat vertice[8][3] = {
		{ -desp + 0.5*largo ,-0.5*altura, 0.5*profundidad },    //Coordenadas Vértice 1 V1
		{ -desp - 0.5*largo ,-0.5*altura , 0.5*profundidad },    //Coordenadas Vértice 2 V2
		{ -desp - 0.5*largo ,-0.5*altura , -0.5*profundidad },    //Coordenadas Vértice 3 V3
		{ -desp + 0.5*largo ,-0.5*altura , -0.5*profundidad },    //Coordenadas Vértice 4 V4
		{ desp + 0.5*largo ,0.5*altura , 0.5*profundidad },    //Coordenadas Vértice 5 V5
		{ desp + 0.5*largo ,0.5*altura , -0.5*profundidad },    //Coordenadas Vértice 6 V6
		{ desp - 0.5*largo ,0.5*altura , -0.5*profundidad },    //Coordenadas Vértice 7 V7
		{ desp - 0.5*largo ,0.5*altura , 0.5*profundidad },    //Coordenadas Vértice 8 V8
	};
...
void CFiguras::piramide(float BaseMayor, float Basemenor, float altura, GLuint text)  //Funcion creacion piramide
{

	float	hipo = 0.0;

	hipo = sqrt((altura*altura) + (((BaseMayor - Basemenor)/(2))*((BaseMayor - Basemenor) / (2))));

	GLfloat vertice[8][3] = {
		{ 0.5*BaseMayor ,-0.5*hipo, 0.5*BaseMayor },    //Coordenadas Vértice 1 V1
		{ -0.5*BaseMayor ,-0.5*hipo , 0.5*BaseMayor },    //Coordenadas Vértice 2 V2
		{ -0.5*BaseMayor ,-0.5*hipo , -0.5*BaseMayor },    //Coordenadas Vértice 3 V3
		{ 0.5*BaseMayor ,-0.5*hipo , -0.5*BaseMayor },    //Coordenadas Vértice 4 V4
		{ 0.5*Basemenor ,0.5*hipo , 0.5*Basemenor },    //Coordenadas Vértice 5 V5
		{ 0.5*Basemenor ,0.5*hipo , -0.5*Basemenor },    //Coordenadas Vértice 6 V6
		{ -0.5*Basemenor ,0.5*hipo , -0.5*Basemenor },    //Coordenadas Vértice 7 V7
		{ -0.5*Basemenor ,0.5*hipo , 0.5*Basemenor },    //Coordenadas Vértice 8 V8
	};
	...
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0456f, 1.0f); glVertex3fv(vertice[4]);
	glTexCoord2f(0.9544f, 1.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
	glEnd();
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.9544f, 1.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0456f, 1.0f); glVertex3fv(vertice[4]);
	glEnd();

	glBegin(GL_POLYGON);	//Back
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.0456f, 1.0f); glVertex3fv(vertice[6]);
	glTexCoord2f(0.9544f, 1.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glEnd();
...
void CFiguras::prisma3(GLuint frente, GLuint derecha, GLuint espalda, GLuint izquierda, GLuint fondo, GLuint arriba)  //Funcion creacion prisma
{
	...
	glBindTexture(GL_TEXTURE_2D, frente);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Front Frente
							//glColor3f(0.0,0.0,1.0);
	glNormal3f(0.0f, 0.0f, 1.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[4]);
	...
	glBindTexture(GL_TEXTURE_2D, derecha);
	...
	glBindTexture(GL_TEXTURE_2D, espalda);
	glBegin(GL_POLYGON);	//Back Espalda
	...
	glBindTexture(GL_TEXTURE_2D, izquierda);
	glBegin(GL_POLYGON);  //Left
						  //glColor3f(1.0,1.0,1.0);
	glNormal3f(-1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	...
	glBegin(GL_POLYGON);  //Bottom Fondo
